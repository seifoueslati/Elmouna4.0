              ...
              <div class="masonry-item col-12">
                ...
                <div class="bd bgc-white" id="">
                  <div class="peers fxw-nw@lg+ ai-s">
                    ...
                    <div id="ui-right">
                        <div id="node-search" hidden title="Start typing name or id to filter nodes"><input type="text" class="js-node-search" placeholder="Start typing name or id to filter nodes" /></div>
                        <div hidden id="ui-nodes"></div>
                    </div>
