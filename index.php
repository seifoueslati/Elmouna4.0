					...
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-blue weight-500 font-24" id="ui-nodes2">4</span>
								<p class="weight-400 font-18">Anchors</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
								<div class="col-sm-6 text-muted weight-500">all</div>
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-green weight-500 font-24">10</span>
								<p class="weight-400 font-18">Product</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
							...
							<div class="progress" style="height: 10px;">
								<div class="progress-bar bg-light-green progress-bar-striped progress-bar-animated" role="progressbar" style="width: 20%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-orange weight-500 font-24">Workers</span>
								<p class="weight-400 font-18">11</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
				...
				<div class="col-lg-3 col-md-6 col-sm-12 mb-30">
					<div class="bg-white pd-20 box-shadow border-radius-5 margin-5 height-100-p">
						<div class="project-info clearfix">
							...
							<div class="project-info-right">
								<span class="no text-light-purple weight-500 font-24">Nodes</span>
								<p class="weight-400 font-18">4</p>
							</div>
						</div>
						<div class="project-info-progress">
							<div class="row clearfix">
...
*/
				...
				?>
					...
					<div class="col-sm-12 col-md-4 col-lg-3">
						<h5 class="mb-30 weight-500">Current Workers</h5>
	
						<?php


$sql = "select * from worker  Limit 5";
...
if ($result->num_rows > 0) {
  ...
  while($row = $result->fetch_assoc()) {
	...
	?>
						...
						<div class="mb-30">
							<p class="mb-5 font-18"><?php echo $row["username"] ;?></p>
							<div class="progress border-radius-0" style="height: 10px;">
								<div class="progress-bar bg-orange" role="progressbar" style="width: 100%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
							</div>
						</div>
